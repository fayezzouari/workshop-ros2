...
bool pubsub_demo__msg__custom_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pubsub_demo.msg._custom_message", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("CustomMessage", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  pubsub_demo__msg__CustomMessage * ros_message = _ros_message;
  {  // name
...
PyObject * pubsub_demo__msg__custom_message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pubsub_demo.msg._custom_message");
